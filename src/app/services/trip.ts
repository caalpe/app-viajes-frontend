  ...
  getTrips(): Observable<TripModel[]> {
    ...
    const data: TripModel[] = [
      { 
        ...
        priceNumber: 120, 
        cost_per_person: 120,
        image_url: 'https://source.unsplash.com/800x600/?barcelona', 
      ...
      { 
        ...
        priceNumber: 340, 
        cost_per_person: 340,
        image_url: 'https://source.unsplash.com/800x600/?andalucia', 
      ...
      { 
        ...
        priceNumber: 255, 
        cost_per_person: 255,
        image_url: 'https://source.unsplash.com/800x600/?mountains', 
